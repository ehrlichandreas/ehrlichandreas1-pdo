...
require_once 'EhrlichAndreas/Pdo/Adapter/Mysql/Statement.php';

/**
 *
 * @author Ehrlich, Andreas <ehrlich.andreas@googlemail.com>
 */
class EhrlichAndreas_Pdo_Adapter_Mysql extends EhrlichAndreas_Pdo_Adapter_Abstract
{
    ...
    protected function connect (&$username, &$password, &$driver_options)
    {
        ...
        if (! $this->link)
        {
            ...
            $this->set_error($errno, mysql_error(), $state, EhrlichAndreas_Pdo_Abstract::ERRMODE_EXCEPTION, '__construct');
        }
        ...
        if ($this->driver_options[EhrlichAndreas_Pdo_Adapter_Abstract::MYSQL_ATTR_INIT_COMMAND])
        {
            if (! mysql_unbuffered_query($this->driver_options[EhrlichAndreas_Pdo_Adapter_Abstract::MYSQL_ATTR_INIT_COMMAND], $this->link))
            {
                $this->set_driver_error(null, EhrlichAndreas_Pdo_Abstract::ERRMODE_EXCEPTION, '__construct');
            }
        }
