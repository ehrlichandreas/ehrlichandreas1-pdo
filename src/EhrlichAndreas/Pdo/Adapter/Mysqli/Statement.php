 ...
 */
class EhrlichAndreas_Pdo_Adapter_Mysqli_Statement extends EhrlichAndreas_Pdo_Adapter_Abstract_Statement
{
    ...
    public function getColumnMeta ($column)
    {
        ...
        switch ($info->type)
        {
            ...
            /*
             * case MYSQLI_TYPE_DECIMAL: case MYSQLI_TYPE_NEWDECIMAL: case
             * MYSQLI_TYPE_TINY: case MYSQLI_TYPE_SHORT: case MYSQLI_TYPE_LONG:
             * case MYSQLI_TYPE_FLOAT: case MYSQLI_TYPE_DOUBLE: case
             * MYSQLI_TYPE_LONGLONG: case MYSQLI_TYPE_INT24; $pdo_type =
             * EhrlichAndreas_Pdo_Abstract::PARAM_INT; break; case
             * MYSQLI_TYPE_TINY_BLOB: case MYSQLI_TYPE_MEDIUM_BLOB: case
             * MYSQLI_TYPE_LONG_BLOB: case MYSQLI_TYPE_BLOB: $pdo_type =
             * EhrlichAndreas_Pdo_Abstract::PARAM_LOB; break; case MYSQLI_TYPE_NULL:
             * $pdo_type = EhrlichAndreas_Pdo_Abstract::PARAM_NULL; break;
             */
        ...
        if ($cnt > 1)
        {
            ...
            for ($x = 1; $x < $cnt; $x ++)
            {
                ...
                switch ($bound_params[$x][1])
                {
                    ...
                    case EhrlichAndreas_Pdo_Abstract::PARAM_STR:
    ...
    private function send_lobs ()
    {
        foreach ($this->lobs as $k => &$v)
        {
            ...
            elseif (! mysqli_stmt_send_long_data($this->_result, $k, $v))
            {
                return false;
            }
        }
